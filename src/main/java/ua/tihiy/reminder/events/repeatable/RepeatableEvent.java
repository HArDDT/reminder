...
public class RepeatableEvent {
    ...
    public RepeatableEvent(int userId, String description, String eventDate, boolean activeEvent, String reminderExpression) {
        this.userId = userId;
    ...
    public RepeatableEvent(int id, int userId, String description, String eventDate, boolean activeEvent, String reminderExpression) {
        this.id = id;
        this.userId = userId;
        this.description = description;
        this.eventDate = ZonedDateTime.parse(eventDate, DateTimeFormatter.RFC_1123_DATE_TIME).toLocalDateTime();
    ...
    public RepeatableEvent(int id, int userId, String description, LocalDateTime eventDate, boolean activeEvent, String reminderExpression) {
        this.id = id;
        this.userId = userId;
        this.description = description;
    ...
    public boolean equals(Object o) {
        ...
        return id == repeatableEvent.id &&
                userId == repeatableEvent.userId;
    }
